...
#define TYPE_VERSATILE_PB_SIC "Dummyversatilepb_sic"
...
static void versatilepb_class_init(ObjectClass *oc, void *data)
{
    ...
    mc->desc = "Dummy ARM Versatile/PB (ARM926EJ-S)";
    mc->init = vpb_init;
...
static const TypeInfo versatilepb_type = {
    .name = MACHINE_TYPE_NAME("Dummysversatilepb"),
    .parent = TYPE_MACHINE,
...
static void versatileab_class_init(ObjectClass *oc, void *data)
{
    ...
    mc->desc = "Dummy ARM Versatile/AB (ARM926EJ-S)";
    mc->init = vab_init;
    mc->block_default_type = IF_SCSI;
    mc->ignore_memory_transaction_failures = true;
    mc->default_cpu_type = ARM_CPU_TYPE_NAME("arm926");
...
static const TypeInfo versatileab_type = {
    .name = MACHINE_TYPE_NAME("Dummysversatileab"),
    .parent = TYPE_MACHINE,
